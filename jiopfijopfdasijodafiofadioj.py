...
class App(tk.Tk):
    def __init__(self):
        ...
        self.lbl1 = tk.Label(self.frm1, text='Usuario')
        self.lbl1.grid(row=1, column=0)

        self.ntry1 = tk.Entry(self.frm1)
        self.ntry1.grid(row=2, column=0)

        self.lbl2 = tk.Label(self.frm1, text='Senha')
        self.lbl1.grid(row=3, column=0)

        self.ntry2 = tk.Entry(self.frm1)
        self.ntry2.grid(row=4, column=0)

        self.bttn1 = tk.Button(self.frm1, text='Entrar', command=self.entrar)
        self.bttn1.grid(row=5, column=0)
